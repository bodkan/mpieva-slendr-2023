...
Let's talk about "real" simulations.
...
```{r}
library(dplyr) # load data analysis and plotting packages
library(ggplot2)
library(magrittr)
...
<h4>build simple models</h4>

<br>

<h4>simulate data from them</h4>

<br>

<h4>in just one R script</h4>

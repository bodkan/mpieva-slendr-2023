...
## Remember that *slendr* objects carry their history
...
<small> <code> Warning message: No valid sampling events were retained </code> </small>
...
```{r}
#| echo: false
ts <- ts_simplify(ts, simplify_to = c("EUR_1", "EUR_2", "AFR_1"))
```
